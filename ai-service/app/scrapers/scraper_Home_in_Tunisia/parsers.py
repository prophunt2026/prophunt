...
from app.scrapers.scraper_Home_in_Tunisia.config import ETAT_MAP, EQUIPEMENT_KEYWORDS
from app.scrapers.scraper_Home_in_Tunisia.config import PAYS_VOULUS, DEVISES_VOULUES, TYPES_VOULUS, MOTS_CLES_EXCLUS
from app.scrapers.scraper_Home_in_Tunisia.models import empty_record
